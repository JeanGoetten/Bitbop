...
const avnetura = new Schema({
    ...
    //char set
    avatar: {type: String, require: true, default: "../img/default.jpg"}, 
    ...
    aventura: {type: String, require: true, default: 'Chain Quest'}

})

mongoose.model("new_adventure", avnetura)